...
const DungeonShowcase: React.FC = () => {
  const dungeons: Dungeon[] = [
    ...
    { dungeonId: 'war_god_arena', name: '전쟁신의 투기장', requiredWalkTime: 2400, requiredDistance: 192000, monsterStats: { hp: 3000, attack: 200, defense: 70 }, expReward: 12000, difficulty: 'nightmare', bossType: 'god_of_war', isLegendary: true, description: '전쟁의 신이 직접 상대하는 신성한 투기장' },
    { dungeonId: 'void_lord_dimension', name: '공허군주의 차원', requiredWalkTime: 3600, requiredDistance: 288000, monsterStats: { hp: 3500, attack: 220, defense: 80 }, expReward: 15000, difficulty: 'nightmare', bossType: 'void_lord', isLegendary: true, description: '공허의 군주가 지배하는 무의 차원' },
    { dungeonId: 'chaos_emperor_palace', name: '혼돈황제의 궁전', requiredWalkTime: 4800, requiredDistance: 384000, monsterStats: { hp: 4000, attack: 250, defense: 90 }, expReward: 20000, difficulty: 'nightmare', bossType: 'chaos_emperor', isLegendary: true, description: '혼돈의 황제가 현실을 왜곡시키는 궁전' },
    { dungeonId: 'infinity_beast_realm', name: '무한야수의 영역', requiredWalkTime: 6000, requiredDistance: 480000, monsterStats: { hp: 5000, attack: 300, defense: 100 }, expReward: 50000, difficulty: 'nightmare', bossType: 'infinity_beast', isLegendary: true, description: '전설 속에서만 존재한다는 궁극의 던전. 아무도 클리어한 적이 없다.' }
  ];
